export default function ProductsTab() {
  const products = [
    { sku: "RTL-001", name: "Fresh Apples", stock: 120, price: 3.99, status: "In Stock" },
    { sku: "RTL-002", name: "Organic Milk", stock: 45, price: 5.49, status: "In Stock" },
    { sku: "RTL-003", name: "Whole Wheat Bread", stock: 15, price: 4.29, status: "Low Stock" },
    { sku: "RTL-004", name: "Orange Juice", stock: 68, price: 6.99, status: "In Stock" },
  ];
