        ...
        <div className="border border-gray-100 rounded-xl p-5 bg-gray-50/30">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex justify-between items-center text-sm">
              ...
              <span className="font-bold text-theme-text">85% Full</span>
            </div>
            <div className="flex justify-between items-center text-sm">
              <span className="text-gray-600">Zone B - Dry Goods</span>
              <span className="font-bold text-theme-text">62% Full</span>
            </div>
            <div className="flex justify-between items-center text-sm">
              <span className="text-gray-600">Zone C - Frozen</span>
              <span className="font-bold text-theme-text">45% Full</span>
            </div>
          </div>
        </div>
        ...
        <div className="border border-gray-100 rounded-xl p-5 bg-gray-50/30">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex justify-between items-center text-sm">
              ...
              <span className="font-bold text-theme-text">45 items</span>
            </div>
            <div className="flex justify-between items-center text-sm">
              <span className="text-gray-600">Outgoing Today:</span>
              <span className="font-bold text-theme-text">62 items</span>
            </div>
            <div className="flex justify-between items-center text-sm">
              <span className="text-gray-600">Adjustments Pending:</span>
              <span className="font-bold text-theme-text">8 items</span>
            </div>
          </div>
        </div>
