        ...
        <div className="border border-gray-100 rounded-xl p-5 bg-theme-surface shadow-sm">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex justify-between items-center text-sm border-b border-gray-50 pb-2">
              ...
              <span className="font-bold text-gray-900">$89,240</span>
            </div>
            <div className="flex justify-between items-center text-sm border-b border-gray-50 pb-2">
              <span className="text-gray-600">Bulk Orders</span>
              <span className="font-bold text-gray-900">127 orders</span>
            </div>
            <div className="flex justify-between items-center text-sm border-b border-gray-50 pb-2">
            ...
            <div className="flex justify-between items-center text-sm">
              ...
              <span className="font-bold text-gray-900">$702.36</span>
            </div>
          </div>
        </div>
        ...
        <div className="border border-gray-100 rounded-xl p-5 bg-theme-surface shadow-sm">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex justify-between items-center text-sm border-b border-gray-50 pb-2">
              ...
              <span className="font-bold text-gray-900">342 items</span>
            </div>
            <div className="flex justify-between items-center text-sm border-b border-gray-50 pb-2">
