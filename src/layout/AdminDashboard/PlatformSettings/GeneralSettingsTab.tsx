        ...
        <div className="bg-theme-surface rounded-xl shadow-sm border border-gray-100 p-6 lg:p-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input type="text" defaultValue="HubNepa" className="w-full px-4 py-2.5 bg-theme-surface border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-gray-400 focus:ring-1 focus:ring-gray-400 transition shadow-sm" />
            </div>

            <div>
              <label className="block text-sm font-semibold text-theme-text mb-2">Support Email</label>
              <input type="email" defaultValue="support@hubnepa.com" className="w-full px-4 py-2.5 bg-theme-surface border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-gray-400 focus:ring-1 focus:ring-gray-400 transition shadow-sm" />
            </div>
          </div>
        </div>
        ...
        <div className="bg-theme-surface rounded-xl shadow-sm border border-gray-100 p-6 lg:p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
              ...
              <select className="w-full px-4 py-2.5 bg-theme-surface border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-gray-400 focus:ring-1 focus:ring-gray-400 transition shadow-sm">
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input type="text" defaultValue="New York" className="w-full px-4 py-2.5 bg-theme-surface border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-gray-400 focus:ring-1 focus:ring-gray-400 transition shadow-sm" />
              </div>
            </div>
            <div>
              <label className="block text-sm font-semibold text-theme-text mb-2">Address</label>
              <textarea rows={3} defaultValue="123 Main St, New York, NY 10001" className="w-full px-4 py-2.5 bg-theme-surface border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-gray-400 focus:ring-1 focus:ring-gray-400 transition shadow-sm resize-none"></textarea>
            </div>
          </div>
        </div>
        ...
        <div className="bg-theme-surface rounded-xl shadow-sm border border-gray-100 p-6 lg:p-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <textarea rows={3} placeholder="We'll be right back..." className="w-full px-4 py-2.5 bg-theme-surface border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-gray-400 focus:ring-1 focus:ring-gray-400 transition shadow-sm resize-none"></textarea>
            </div>
          </div>
        </div>
      </div>
