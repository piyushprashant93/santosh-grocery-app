...
interface RoleFormProps {
  roleName?: string; // If provided, we are editing. If undefined, we are adding.
  onCancel: () => void;
}

export default function RoleForm({ roleName, onCancel }: RoleFormProps) {
  const isEditing = !!roleName;

  const modules = [
    {
      name: "Dashboard & Analytics",
      desc: "Access to overview and reports.",
      perms: ["View Analytics", "Export Reports"]
    },
    {
      name: "User Management",
      desc: "Manage user accounts.",
      perms: ["View Users", "Edit Users", "Delete Users", "Manage Roles"]
    },
    {
      name: "Partner Management",
      desc: "Manage restaurants & retailers.",
      perms: ["View Partners", "Approve/Reject", "Edit Details"]
    },
    {
      name: "Content Management",
      desc: "Manage CMS and marketing.",
      perms: ["View Content", "Create/Edit", "Publish"]
    },
    {
      name: "Finance & Settlements",
      desc: "Manage payments and payouts.",
      perms: ["View Finances", "Process Payouts"]
    },
    {
      name: "System Settings",
      desc: "Manage global settings.",
      perms: ["View Settings", "Edit Configuration"]
    }
  ];
    ...
    <div className="flex flex-col gap-6 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-gray-100 pb-5">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          ...
          <button className="px-5 py-2 bg-emerald-600 text-white font-medium rounded-lg shadow-sm hover:bg-emerald-700 transition flex-1 sm:flex-none text-center">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input 
                  type="text" 
                  defaultValue={isEditing ? roleName : ''}
